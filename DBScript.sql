...
INSERT INTO `orders` VALUES (1,1,2,1,'2024-09-30 09:51:51',1,'paypal',45.00,'completed'),(2,1,2,2,'2024-09-30 09:51:51',2,'vnpay',28.00,'pending'),(3,1,2,3,'2024-09-30 09:51:51',3,'COD',70.00,'cancelled');
...
CREATE TABLE `payments` (
                            ...
                            `payment_status` enum('Paid','Cancelled','Refund') DEFAULT NULL,
...
INSERT INTO `payments` VALUES (1,1,45.00,'2024-09-30 09:51:51','Paid'),(2,2,28.00,'2024-09-30 09:51:51','Paid'),(3,3,70.00,'2024-09-30 09:51:51','Cancelled');
...
CREATE TABLE `ratings` (
                           ...
                           CONSTRAINT `ratings_ibfk_2` FOREIGN KEY (`order_id`) REFERENCES `orders` (`order_id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `ratings` VALUES (1,1,1,5,'Amazing experience!','2024-09-30 09:51:51'),(2,1,2,4,'Good value for money.','2024-09-30 09:51:51'),(3,1,3,2,'Cancelled, not satisfied.','2024-09-30 09:51:51');
...
CREATE TABLE `transaction` (
                               ...
                               `order_id` int(11) DEFAULT NULL,
                               `amount` decimal(10,2) DEFAULT NULL,
                               `transaction_type` enum('deposit','refund','payment','commission') DEFAULT NULL,
...
INSERT INTO `transaction` VALUES (1,1,1,45.00,'payment','2024-09-30 09:51:51'),(2,1,2,28.00,'payment','2024-09-30 09:51:51'),(3,1,3,70.00,'refund','2024-09-30 09:51:51');
...
/*!40014 SET UNIQUE_CHECKS=@OLD_UNIQUE_CHECKS */;-- MySQL dump 10.13  Distrib 8.0.13, for Win64 (x86_64)
--
-- Host: localhost    Database: ticket_resell_db
-- ------------------------------------------------------
-- Server version	8.0.13
...
-- Dump completed on 2024-10-20 11:04:29
